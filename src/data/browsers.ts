...
export const data : any = {
	css: {
		builtins: [
			...
			].map(function(cmd) { return { name: cmd, desc: "```choicescript\n*choice\n\t# Option 1\n\t\t*comment code here\n\t\t*goto label1\n\t# Option 2\n\t\t*comment code here\n\t\t*goto label2\n\n```\n\nRead more on the [wiki](https://www.google.com)" } } ),
			flowCommands: ["gosub", "gosub_scene", "goto", "goto_random_scene", "goto_scene", 
			"gotoref", "label", "redirect_scene", "return"].map(function(cmd) { return { name: cmd, desc: "*choice\n\t# Option 1\n\t# Option 2" }; } ),
			indentCommands: [
			"achievement", "choice", "else", "elseif", "elsif", 
			"fake_choice", "if", "scene_list", "stat_chart"
			].map(function(cmd) { return { name: cmd, desc: "aa" } } ),
			dedentCommands: ["ending", "finish", "goto", "goto_scene", "redirect_scene"].map(function(cmd) { return { name: cmd, desc: "unknown" }; } )
	}
}