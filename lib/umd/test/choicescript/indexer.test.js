...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../../cssLanguageService", "vscode-languageserver-types", "../../parser/ChoiceScriptIndexer"], factory);
    }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            startup = vscode_languageserver_types_1.TextDocument.create('test://test/startup.txt', 'choicescript', 0, "*title mygame\n*create myvar\n*gosub_scene second_scene\n*finish");
                            secondScene = vscode_languageserver_types_1.TextDocument.create('test://test/second_scene.txt', 'choicescript', 0, "Hello!\nGoodbye...\n*return");
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            ChoiceScriptIndexer_1.ChoiceScriptIndexer.index.purge(startup.uri);
                            index = ChoiceScriptIndexer_1.ChoiceScriptIndexer.index.sync(startup.uri);
                            if (index) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    try {
                        startup = vscode_languageserver_types_1.TextDocument.create('test://test/startup.txt', 'choicescript', 0, "*title mygame\n*create myvar\n*gosub_scene second_scene\n*finish");
                        secondScene = vscode_languageserver_types_1.TextDocument.create('test://test/second_scene.txt', 'choicescript', 0, "Hello!\nGoodbye...\n*return");
                        thirdChapter = vscode_languageserver_types_1.TextDocument.create('test://test/third_chapter.txt', 'choicescript', 0, "");
                        ChoiceScriptIndexer_1.ChoiceScriptIndexer.index.sync(startup.uri, [startup, secondScene, thirdChapter]);
                        index = ChoiceScriptIndexer_1.ChoiceScriptIndexer.index.getProjectIndexForScene(startup.uri);
                        if (!index) {
                            assert.fail("Couldn't find project index.");
                        }
                        assert(index.getSceneList().length === 3, "Index not populating correctly");
                        purgedIndex = ChoiceScriptIndexer_1.ChoiceScriptIndexer.index.purge(startup.uri, [startup.uri, secondScene.uri]);
                        if (!purgedIndex) {
