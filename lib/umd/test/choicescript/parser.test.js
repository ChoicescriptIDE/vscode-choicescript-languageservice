(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "../../parser/ChoiceScriptParser", "../../parser/ChoiceScriptScanner", "../../parser/ChoiceScriptNodes", "../../parser/ChoiceScriptErrors"], factory);
    }
    ...
    var ChoiceScriptErrors_1 = require("../../parser/ChoiceScriptErrors");
    function assertNode(text, parser, f) {
        ...
        assert.ok(parser.accept(ChoiceScriptScanner_1.TokenType.EOF), 'Scanner is not at EOF: ' + parser.token.text + ' (' + parser.token.offset + ')');
        return node;
    }
    ...
    suite('Text - Parser', function () {
        test('Text and Real Words', function () {
            var parser = new ChoiceScriptParser_1.ChoiceScriptParser();
    ...
    suite('ChoiceScript - Parser', function () {
        ...
        test('variables', function () {
            ...
            assertError('*create varwithoutvalue', parser, parser._parseVariableDeclaration.bind(parser), ChoiceScriptErrors_1.ParseError.VariableValueExpected);
        });
        ...
        test('ChoiceScript statement', function () {
            var parser = new ChoiceScriptParser_1.ChoiceScriptParser();
            assertError('*temp', parser, parser._parseChoiceScriptStatement.bind(parser), ChoiceScriptErrors_1.ParseError.VariableNameExpected);
            assertError('*create', parser, parser._parseChoiceScriptStatement.bind(parser), ChoiceScriptErrors_1.ParseError.VariableNameExpected);
            ...
            assertError('*qeif', parser, parser._parseChoiceScriptStatement.bind(parser), ChoiceScriptErrors_1.ParseError.UnknownCommand);
            assertError('*c', parser, parser._parseChoiceScriptStatement.bind(parser), ChoiceScriptErrors_1.ParseError.UnknownCommand);
            assertError('*label', parser, parser._parseChoiceScriptStatement.bind(parser), ChoiceScriptErrors_1.ParseError.LabelNameExpected);
        });
        test('Valid commands', function () {
            ...
            // And invalid:
            assertError('*sets', parser, parser._parseChoiceScriptCommand.bind(parser), ChoiceScriptErrors_1.ParseError.UnknownCommand);
            assertError('*win', parser, parser._parseChoiceScriptCommand.bind(parser), ChoiceScriptErrors_1.ParseError.UnknownCommand);
            assertError('*do_nothing', parser, parser._parseChoiceScriptCommand.bind(parser), ChoiceScriptErrors_1.ParseError.UnknownCommand);
            assertError('*create_array', parser, parser._parseChoiceScriptCommand.bind(parser), ChoiceScriptErrors_1.ParseError.UnknownCommand);
            assertError('*_command', parser, parser._parseChoiceScriptCommand.bind(parser), ChoiceScriptErrors_1.ParseError.UnknownCommand);
        ...
        test('Expressions - \'Complicated\'', function () {
            ...
            assertError('myarray[myotherarray[myfinalarray[]]]', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.TermExpected);
            assertError('myarray[myotherarray[myfinalarray[0]', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.RightSquareBracketExpected);
            assertError('myarray[myotherarray[myfinalarray[0]]', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.RightSquareBracketExpected);
            assertError('{{myvarref}', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.RightCurlyExpected);
            assertError('var and not(var))', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.LeftParenthesisExpected);
            assertError('not(not(x) and not(x)', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.RightParenthesisExpected);
            assertError('(item and item and item)', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.RightParenthesisExpected);
            assertError('((item and item and item)', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.RightParenthesisExpected);
            assertError('item)', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.OperatorExpected);
            assertError('(var and var) ! var', parser, parser._parseCSExpr.bind(parser), ChoiceScriptErrors_1.ParseError.InvalidVariableFormatOption);
        });
        /*
        ...
        */
        test('Assignments', function () {
            ...
            assertNode('*set myvar %-(round(modifier/4)+((other_mod-1)*100))', parser, parser._parseSetCommand.bind(parser));
            assertError('*set {n modulo 7', parser, parser._parseSetCommand.bind(parser), ChoiceScriptErrors_1.ParseError.RightCurlyExpected);
        });
