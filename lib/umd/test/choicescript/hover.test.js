...
(function (factory) {
    ...
    function assertHover(value, expected, languageId) {
        ...
        var hoverResult = ls.doHover(document, document.positionAt(offset), ls.parseScene(document));
        assert(hoverResult);
    ...
    suite('ChoiceScript Hover', function () {
        ...
        test('command with params', function () {
