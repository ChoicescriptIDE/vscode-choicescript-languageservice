...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "./completion.test", "../../cssLanguageService"], factory);
    }
    ...
    var completion_test_1 = require("./completion.test");
    ...
    suite('CSS - Custom Data', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            test('Completion', function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, completion_test_1.testCompletionFor('body { | }', {
                                items: [
                                    {
                                        label: 'foo',
                        ...
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, completion_test_1.testCompletionFor('|', {
                        ...
                        case 3:
                            _a.sent();
                            return [4 /*yield*/, completion_test_1.testCompletionFor('::foo|', {
                                    items: [{ label: '::foo', resultText: '::foo' }]
                                }, settings, undefined, undefined, customData)];
                        case 4:
                            _a.sent();
    ...
    suite('CSS - Custom Data Diagnostics', function () {
        var customDataProviders = [cssLanguageService_1.newCSSDataProvider({
                version: 1,
                properties: [
                    {
                        name: 'foo'
        ...
        var cssLS = cssLanguageService_1.getCSSLanguageService({ customDataProviders: customDataProviders });
