...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "assert", "path", "../../cssLanguageService", "../testUtil/documentContext", "vscode-uri", "../testUtil/fsProvider", "vscode-languageserver-types"], factory);
    }
    ...
    function assertCompletion(completions, expected, document) {
        ...
        if (expected.resultText && match.textEdit) {
            ...
            assert.equal(cssLanguageService_1.TextDocument.applyEdits(document, [edit]), expected.resultText);
        }
    ...
    ;
    function testCompletionFor(value, expected, settings, testUri, workspaceFolderUri, customData) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        lsOptions = { fileSystemProvider: fsProvider_1.getFsProvider() };
                        if (lang === 'scss') {
                            ls = cssLanguageService_1.getSCSSLanguageService(lsOptions);
                        }
                        else if (lang === 'less') {
                            ls = cssLanguageService_1.getLESSLanguageService(lsOptions);
                        }
                        else {
                            ls = cssLanguageService_1.getCSSLanguageService(lsOptions);
                        }
                        ...
                        document = cssLanguageService_1.TextDocument.create(testUri, lang, 0, value);
                        position = cssLanguageService_1.Position.create(0, offset);
                        jsonDoc = ls.parseStylesheet(document);
                        context = documentContext_1.getDocumentContext(workspaceFolderUri);
    ...
    suite('CSS - Completion', function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 5:
                            _a.sent();
                            return [4 /*yield*/, testCompletionFor('a::| foo { }', {
                                    items: [
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, testCompletionFor('@keyframes fadeIn { 0% { transform: s|', {
                                items: [
                                    { label: 'scaleX()', resultText: '@keyframes fadeIn { 0% { transform: scaleX($1)', insertTextFormat: cssLanguageService_1.InsertTextFormat.Snippet }
                                ]
                            })];
                        case 1:
                            _a.sent();
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, testCompletionFor('.foo { unknown: foo; } .bar { unknown:| }', {
                                    items: [
                                        { label: 'foo', kind: cssLanguageService_1.CompletionItemKind.Value, resultText: '.foo { unknown: foo; } .bar { unknown:foo }' }
                                    ]
                                })];
                        case 2:
                            _a.sent();
                    ...
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, testCompletionFor('.foo { background-color: #123456; } .bar { background-color:| }', {
                                    items: [
                                        { label: '#123456', kind: cssLanguageService_1.CompletionItemKind.Color, resultText: '.foo { background-color: #123456; } .bar { background-color:#123456 }' }
                                    ]
                                })];
                        case 4:
                            _a.sent();
                        ...
                        case 5:
                            ...
                            return [4 /*yield*/, testCompletionFor('.foo { background-color: r|', {
                                    items: [
                                        { label: 'rgb', kind: cssLanguageService_1.CompletionItemKind.Function, resultText: '.foo { background-color: rgb(${1:red}, ${2:green}, ${3:blue})' },
                                        { label: 'rgba', kind: cssLanguageService_1.CompletionItemKind.Function, resultText: '.foo { background-color: rgba(${1:red}, ${2:green}, ${3:blue}, ${4:alpha})' },
                                        { label: 'red', kind: cssLanguageService_1.CompletionItemKind.Color, resultText: '.foo { background-color: red' }
                                    ]
                                })];
                        case 6:
                            _a.sent();
                    ...
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            return [4 /*yield*/, testCompletionFor("html { background-image: url(|)", {
                                    count: 0,
                                    participant: {
                                        onURILiteralValue: [{ uriValue: '', position: cssLanguageService_1.Position.create(0, 29), range: newRange(29, 29) }]
                                    }
                                })];
                        case 4:
                            _a.sent();
                            return [4 /*yield*/, testCompletionFor("html { background-image: url('|')", {
                                    count: 0,
                                    participant: {
                                        onURILiteralValue: [{ uriValue: "''", position: cssLanguageService_1.Position.create(0, 30), range: newRange(29, 31) }]
                                    }
                                })];
                        case 5:
                            _a.sent();
                            return [4 /*yield*/, testCompletionFor("html { background-image: url(\"b|\")", {
                                    count: 0,
                                    participant: {
                                        onURILiteralValue: [{ uriValue: "\"b\"", position: cssLanguageService_1.Position.create(0, 31), range: newRange(29, 32) }]
                                    }
                                })];
                        case 6:
                            _a.sent();
                            return [4 /*yield*/, testCompletionFor("html { background: url(\"b|\"", {
                                    count: 0,
                                    participant: {
                                        onURILiteralValue: [{ uriValue: "\"b\"", position: cssLanguageService_1.Position.create(0, 25), range: newRange(23, 26) }]
                                    }
                                })];
                        case 7:
                            _a.sent();
                            return [4 /*yield*/, testCompletionFor("@import './|'", {
                                    count: 0,
                                    participant: {
                                        onImportPath: [{ pathValue: "'./'", position: cssLanguageService_1.Position.create(0, 11), range: newRange(8, 12) }]
                                    }
                                })];
                        case 8:
                            _a.sent();
                        ...
                        case 9:
                            ...
                            return [4 /*yield*/, testCompletionFor("@import \"./|foo\";", {
                                    count: 0,
                                    participant: {
                                        onImportPath: [{ pathValue: "\"./foo\"", position: cssLanguageService_1.Position.create(0, 11), range: newRange(8, 15) }]
                                    }
                                })];
                        case 10:
                            _a.sent();
                            ...
                            items: [
                                {
                                    label: '--foo',
                                    documentation: '#bbb',
                                    kind: cssLanguageService_1.CompletionItemKind.Color
                                }
                            ]
                        })];
                    case 1:
        ...
        test('Properties sorted by relevance', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        customData = [cssLanguageService_1.newCSSDataProvider({
                                version: 1,
                                properties: [
        ...
        test('CSS url() Path completion', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            testUri = vscode_uri_1.URI.file(path.resolve(testFixturesPath, 'pathCompletionFixtures/about/about.css')).toString();
