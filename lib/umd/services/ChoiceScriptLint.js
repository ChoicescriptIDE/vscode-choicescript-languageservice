(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./ChoiceScriptLintRules", "../parser/ChoiceScriptNodes", "../data/commands", "vscode-nls", "../parser/ChoiceScriptErrors", "../parser/ChoiceScriptIndexer"], factory);
    }
    ...
    var ChoiceScriptLintRules_1 = require("./ChoiceScriptLintRules");
    ...
    var LintVisitor = /** @class */ (function () {
        function LintVisitor(scene, settings) {
            ...
            var properties = settings.getSetting(ChoiceScriptLintRules_1.Settings.ValidProperties);
        ...
        LintVisitor.prototype.visitVariableDeclaration = function (node) {
            ...
            if (!varName) {
                ...
                this.addEntry(node, ChoiceScriptLintRules_1.Rules.ReservedVariablePrefix);
            }
            else if (commands_1.reservedWords.indexOf(varName) >= 0) {
                this.addEntry(node, ChoiceScriptLintRules_1.Rules.ReservedWord);
            }
            return true;
        };
        LintVisitor.prototype.visitCommand = function (node) {
            var _a, _b;
            if (node.name === "script") {
                this.addEntry(node, ChoiceScriptLintRules_1.Rules.ScriptCommandUnsupported);
            }
            if (commands_1.allCommands[node.name] && commands_1.allCommands[node.name].type === commands_1.CommandType.Deprecated) {
                this.addEntry(node, ChoiceScriptLintRules_1.Rules.DeprecatedCommand);
            }
            ...
            if (node instanceof nodes.SetCommand) {
                ...
                if (variable && expression) {
                    var projectIndex = ChoiceScriptIndexer_1.ChoiceScriptIndexer.index.getProjectIndexForScene(this.document.uri);
                    if (projectIndex) {
                        ...
                        if (symbol) {
                            ...
                            if ((_a = varDec.getVariable()) === null || _a === void 0 ? void 0 : _a.const) {
                                this.addEntry(node, ChoiceScriptLintRules_1.Rules.ConstError);
                            }
                            if ((expression === null || expression === void 0 ? void 0 : expression.csType) !== ((_b = varDec.getExpr()) === null || _b === void 0 ? void 0 : _b.csType)) {
                                ...
                                this.addEntry(node, ChoiceScriptLintRules_1.Rules.TypeError);
                            }
                        }
                    }
                }
        ...
        LintVisitor.prototype.visitOperator = function (node) {
            if (node.getText() === '%') {
                this.addEntry(node, ChoiceScriptLintRules_1.Rules.DeprecatedOperatorPercent);
            }
            return false;
        };
        LintVisitor.prototype.lintInitialCommands = function (sceneNode) {
            ...
            for (var _i = 0, _a = sceneNode.getChildren(); _i < _a.length; _i++) {
                ...
                else if (lineChild && lineChild.hasIssue(ChoiceScriptErrors_1.ParseError.UnknownCommand)) {
                    continue;
                }
                else if (lineChild && lineChild.name === "comment") {
                    continue;
                }
                var command = commands_1.allCommands[lineChild.name];
                if (command.type === commands_1.CommandType.Initial && !allowInitialCommands) {
                    this.addEntry(lineChild, ChoiceScriptLintRules_1.Rules.InvalidInitialCommand);
                }
                else if (command.type !== commands_1.CommandType.Initial) {
        ...
        LintVisitor.prototype.lintChoiceScriptStats = function (sceneNode) {
            for (var _i = 0, _a = sceneNode.getChildren(); _i < _a.length; _i++) {
                ...
                switch (commandNode.name) {
                    ...
                    case 'goto_scene':
                    case 'ending':
                        this.addEntry(commandNode, ChoiceScriptLintRules_1.Rules.UnusualStatsCommand);
                    default:
                        break;
                }
            }
        ...
        LintVisitor.prototype.lintUniqueCommands = function (sceneNode) {
            ...
            for (var _i = 0, _a = sceneNode.getChildren(); _i < _a.length; _i++) {
                ...
                if (typeof uniqueCommands[commandNode.name] === "boolean") {
                    ...
                    this.addEntry(commandNode, ChoiceScriptLintRules_1.Rules.DuplicateUniqueCommand);
                }
            }
        };
