...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../parser/ChoiceScriptNodes", "./ChoiceScriptLintRules", "../cssLanguageTypes", "./spellcheck", "./ChoiceScriptLint", "./typo/typo"], factory);
    }
    ...
    exports.ChoiceScriptValidation = void 0;
    ...
    var ChoiceScriptLint_1 = require("./ChoiceScriptLint");
    ...
    var ChoiceScriptValidation = /** @class */ (function () {
        function ChoiceScriptValidation() {
            this.settings = { validate: true, spellcheck: { enabled: false, dictionaryPath: '',
                    dictionary: cssLanguageTypes_1.SpellCheckDictionary.EN_US, userDictionary: { "session": {}, "persistent": {} } }, lint: {} };
            this.typo = null;
        ...
        ChoiceScriptValidation.prototype.doValidation = function (document, scene, settings) {
            ...
            if (settings && settings.spellcheck.enabled === true) {
                entries.push.apply(entries, spellcheck_1.SpellCheckVisitor.entries(scene, document, this.typo, this.settings.spellcheck.userDictionary));
            }
            if (settings && settings.lint && settings.lint.enabled === true) {
                entries.push.apply(entries, ChoiceScriptLint_1.LintVisitor.entries(scene, document, new ChoiceScriptLintRules_1.LintConfigurationSettings(settings && settings.lint)));
            }
            if (settings && !settings.spellcheck.enabled && !settings.validate) {
                return [];
            }
            var ruleIds = [];
            for (var r in ChoiceScriptLintRules_1.Rules) {
                ruleIds.push(ChoiceScriptLintRules_1.Rules[r].id);
            }
