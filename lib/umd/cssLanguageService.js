...
(function (factory) {
    ...
    exports.getChoiceScriptLanguageService = exports.getLESSLanguageService = exports.getSCSSLanguageService = exports.getCSSLanguageService = exports.newCSSDataProvider = exports.getDefaultCSSDataProvider = void 0;
    var ChoiceScriptParser_1 = require("./parser/ChoiceScriptParser");
    var ChoiceScriptIndexer_1 = require("./parser/ChoiceScriptIndexer");
    var ChoiceScriptCompletion_1 = require("./services/ChoiceScriptCompletion");
    var ChoiceScriptHover_1 = require("./services/ChoiceScriptHover");
    ...
    function getChoiceScriptLanguageService(options) {
        var choicescriptDataManager = new dataManager_1.CSSDataManager(options);
        return createChoiceScriptFacade(new ChoiceScriptParser_1.ChoiceScriptParser(), new ChoiceScriptCompletion_1.ChoiceScriptCompletion(null, options && options.clientCapabilities), new ChoiceScriptHover_1.ChoiceScriptHover(options && options.clientCapabilities), new ChoiceScriptNavigation_1.ChoiceScriptNavigation(), new ChoiceScriptValidation_1.ChoiceScriptValidation(), ChoiceScriptIndexer_1.ChoiceScriptIndexer.index);
    }
    exports.getChoiceScriptLanguageService = getChoiceScriptLanguageService;
    function createChoiceScriptFacade(parser, completion, hover, navigation, validation, indexer) {
        return {
            configure: function (settings) {
                validation.configure(settings);
                completion.configure(settings);
