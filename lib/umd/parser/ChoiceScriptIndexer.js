(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../parser/ChoiceScriptParser", "./ChoiceScriptSymbolScope"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ChoiceScriptProjectIndex = exports.ChoiceScriptIndexer = void 0;
    var ChoiceScriptParser_1 = require("../parser/ChoiceScriptParser");
    var ChoiceScriptSymbolScope_1 = require("./ChoiceScriptSymbolScope");
    ...
    exports.ChoiceScriptIndexer = ChoiceScriptIndexer;
    var ChoiceScriptProjectIndex = /** @class */ (function () {
        ...
        ChoiceScriptProjectIndex.prototype.getSceneSymbolsByName = function (name) {
            ...
            return new ChoiceScriptSymbolScope_1.Symbols(node);
        };
    ...
    exports.ChoiceScriptProjectIndex = ChoiceScriptProjectIndex;
});
