...
import { TextEdit, TextDocument, Position, Range } from 'vscode-languageserver-types';
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        startup = TextDocument.create('test://test/startup.txt', 'choicescript', 0, '*create a "e"\n' +
                            '*create n 0\n' +
                            '*create t false\n' +
                            '*temp x "y"\n' +
                            '*temp y "z"');
                        not_startup = TextDocument.create('test://test/not_startup.txt', 'choicescript', 0, '*label look\n' +
                            '*temp z 7\n' +
                            '*set a "b"\n' +
                            '*set n 0\n' +
                            '*set t false');
                        return [4 /*yield*/, assertDefinition({ uri: "test://test/not_startup.txt", position: Position.create(4, 5) }, { uri: "test://test/startup.txt", range: Range.create(Position.create(2, 0), Position.create(2, 15)) }, [startup, not_startup])];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        startup = TextDocument.create('test://test/startup.txt', 'choicescript', 0, readFileSync("./src/test/choicescript/data/scenes/navigation/find_temp_over_create_def_startup.txt").toString());
                        not_startup = TextDocument.create('test://test/not_startup.txt', 'choicescript', 0, readFileSync("./src/test/choicescript/data/scenes/navigation/find_temp_over_create_def_local.txt").toString());
                        return [4 /*yield*/, assertDefinition({ uri: "test://test/not_startup.txt", position: Position.create(3, 5) }, { uri: "test://test/not_startup.txt", range: Range.create(Position.create(1, 0), Position.create(1, 9)) }, [startup, not_startup])];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        startup = TextDocument.create('test://test/startup.txt', 'choicescript', 0, readFileSync("./src/test/choicescript/data/scenes/navigation/goto_scene_scene_def.txt").toString());
                        not_startup = TextDocument.create('test://test/not_startup.txt', 'choicescript', 0, "");
                        ...
                        return [4 /*yield*/, assertDefinition({ uri: "test://test/startup.txt", position: Position.create(lines.indexOf(line), charPos) }, { uri: "test://test/not_startup.txt", range: Range.create(Position.create(0, 0), Position.create(0, 0)) }, [startup, not_startup])];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        startup = TextDocument.create('test://test/startup.txt', 'choicescript', 0, readFileSync("./src/test/choicescript/data/scenes/navigation/goto_scene_scene_def.txt").toString());
                        not_startup = TextDocument.create('test://test/not_startup.txt', 'choicescript', 0, "*label not_this_one\nHello\nWorld!\n*label mylabel\n*finish");
                        ...
                        return [4 /*yield*/, assertDefinition({ uri: "test://test/startup.txt", position: Position.create(lines.indexOf(line), charPos) }, {
