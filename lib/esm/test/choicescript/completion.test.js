...
import { getChoiceScriptLanguageService, TextDocument, Position, Range, } from '../../cssLanguageService';
import { readFileSync } from 'fs';
import { TextEdit } from 'vscode-languageserver-types';
function asPromise(result) {
    return Promise.resolve(result);
}
export var assertCompletion = function (completions, expected, document) {
    ...
    if (expected.resultText && match.textEdit) {
        ...
        var res = TextDocument.applyEdits(document, [edit]);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        ls = getChoiceScriptLanguageService();
                        ...
                        document = TextDocument.create('test://test/local.txt', 'choicescript', 0, value);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        value = "*c";
                        return [4 /*yield*/, testCompletionFor(value, Position.create(0, value.length), {
                                items: [
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        value = "*";
                        return [4 /*yield*/, testCompletionFor('*', Position.create(0, value.length), {
                                items: [],
                            })];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        value = readFileSync("./src/test/choicescript/data/scenes/completion/replacement_vars.txt").toString();
                        lines = value.split("\n");
                        line = lines.filter(function (line) { return line.indexOf("${f}") >= 0; })[0];
                        charPos = line.indexOf("${f") + 3;
                        return [4 /*yield*/, testCompletionFor(value, Position.create(lines.indexOf(line), charPos), {
                                items: [
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        value = readFileSync("./src/test/choicescript/data/scenes/completion/variables.txt").toString();
                        lines = value.split("\n");
                        line = lines[lines.length - 1];
                        charPos = line.indexOf("my") + 2;
                        return [4 /*yield*/, testCompletionFor(value, Position.create(lines.length - 1, charPos), {
                                items: [
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        startupScene = TextDocument.create('test://test/startup.txt', 'choicescript', 0, readFileSync("./src/test/choicescript/data/scenes/completion/variables_startup.txt").toString());
                        value = readFileSync("./src/test/choicescript/data/scenes/completion/variables.txt").toString();
                        lines = value.split("\n");
                        line = lines[lines.length - 1];
                        charPos = line.indexOf("my") + 2;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        value = readFileSync("./src/test/choicescript/data/scenes/completion/labels_goto.txt").toString();
                        lines = value.split("\n");
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        value = readFileSync("./src/test/choicescript/data/scenes/completion/variables_nothing.txt").toString();
                        return [4 /*yield*/, testCompletionFor(value, Position.create(value.split("\n").length, value.length), {
                                items: [],
                            })];
                    case 1:
                        _a.sent();
                ...
                switch (_a.label) {
                    case 0:
                        scenes = [
                            ...
                            TextDocument.create('test://test/local.txt', 'choicescript', 0, ""),
