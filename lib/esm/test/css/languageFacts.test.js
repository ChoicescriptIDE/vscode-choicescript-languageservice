...
import { isColorValue, getColorValue, getBrowserLabel, colorFrom256RGB, colorFromHex, hexDigit, hslFromColor } from '../../languageFacts/facts';
import { Parser } from '../../parser/cssParser';
import * as nodes from '../../parser/cssNodes';
import { TextDocument } from '../../cssLanguageTypes';
import { CSSDataManager } from '../../languageFacts/dataManager';
export function assertColor(parser, text, selection, expected, isColor) {
    if (isColor === void 0) { isColor = expected !== null; }
    var document = TextDocument.create('test://test/test.css', 'css', 0, text);
