...
import { Level } from '../../parser/cssNodes';
import { Parser } from '../../parser/cssParser';
import { LintVisitor } from '../../services/lint';
import { Rules, LintConfigurationSettings } from '../../services/lintRules';
import { TextDocument } from '../../cssLanguageTypes';
import { SCSSParser } from '../../parser/scssParser';
import { LESSParser } from '../../parser/lessParser';
import { CSSDataManager } from '../../languageFacts/dataManager';
var cssDataManager = new CSSDataManager({ useDefaultDataProvider: true });
export function assertEntries(node, document, expectedRules, expectedMessages, settings) {
    ...
    var entries = LintVisitor.entries(node, document, settings, cssDataManager, Level.Error | Level.Warning | Level.Ignore);
...
var parsers = [new Parser(), new LESSParser(), new SCSSParser()];
