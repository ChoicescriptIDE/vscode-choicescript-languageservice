...
suite('Color', function () {
    test('color symbols', function () {
        var ls = getLESSLanguageService();
        assertColorSymbols(ls, '@foo: #ff9977;', { color: colorFrom256RGB(0xff, 0x99, 0x77), range: newRange(6, 13) });
        assertColorSymbols(ls, 'body { @foo: hsl(0, 0%, 100%); }', { color: colorFrom256RGB(255, 255, 255), range: newRange(13, 29) });
        assertColorSymbols(ls, 'body { @foo: hsl(0, 1%, 100%); }', { color: colorFrom256RGB(255, 255, 255), range: newRange(13, 29) });
    });
});
