...
import { getSCSSLanguageService, TextDocument } from '../../cssLanguageService';
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ls = getSCSSLS();
                    document = TextDocument.create(docUri, 'scss', 0, input);
                    stylesheet = ls.parseStylesheet(document);
                    return [4 /*yield*/, ls.findDocumentLinks2(document, stylesheet, getDocumentContext(document.uri))];
                case 1:
                    links = _a.sent();
        ...
        test('SCSS straight links', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, assertLinks(ls, "@import 'foo.scss' print;", [
                                { range: newRange(8, 18), target: 'test://test/foo.scss' }
                            ])];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, assertLinks(ls, "@import 'http://foo.com/foo.css'", [
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                         ...
                         */
                        return [4 /*yield*/, assertLinks(ls, "#navigation { background: #3d3d3d url(gantry-media://gradient-overlay.png); }", [
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ls = getSCSSLS();
                            testUri = getTestResource('about.scss');
                            workspaceFolder = getTestResource('');
                            return [4 /*yield*/, assertLinks(ls, 'html { background-image: url("~foo/hello.html")', [{ range: newRange(29, 46), target: getTestResource('node_modules/foo/hello.html') }], 'scss', testUri, workspaceFolder)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
