...
import { Position, InsertTextFormat, CompletionItemKind } from '../../cssLanguageService';
import { testCompletionFor as testCSSCompletionFor } from '../css/completion.test';
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 13:
                    ...
                    return [4 /*yield*/, testCompletionFor('.test { &::|  }', {
                            items: [
    ...
    test('SCSS @import Path completion', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        testCSSUri = URI.file(path.resolve(testFixturesPath, 'pathCompletionFixtures/about/about.css')).toString();
                        ...
                        */
                        return [4 /*yield*/, testCSSCompletionFor("@import '../scss/|'", {
                                items: [
                    ...
                    case 1:
                        ...
                        */
                        _a.sent();
                        testSCSSUri = URI.file(path.resolve(testFixturesPath, 'pathCompletionFixtures/scss/main.scss')).toString();
